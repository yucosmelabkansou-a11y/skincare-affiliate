...
export const CATEGORY_GROUPS: CategoryGroup[] = [
  ...
  },
  {
    ...
    categories: [
      ...
      { id: 'pores',       label: '毛穴・ニキビ',   emoji: '🫧', tags: ['毛穴', 'ニキビ', 'ナイアシンアミド', '皮脂', 'ざらつき', 'ごわつき'] },
      { id: 'aging',       label: 'エイジングケア', emoji: '🌿', tags: ['エイジングケア', 'レチノール', 'シワ', 'ハリ'] },
      { id: 'brightening', label: '美白・くすみ',   emoji: '🌟', tags: ['美白', 'くすみ', 'ビタミンC', 'シミ'] },
      { id: 'sensitive',   label: '敏感肌',         emoji: '🌸', tags: ['敏感肌', 'ノンケミカル', '無添加', '肌荒れ'] },
    ],
  },
]
